...
public class URLActivity extends Activity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		topRl = (RelativeLayout)findViewById(R.id.url_top_rl);
		findViewById(R.id.url_qrmake_btn).setOnClickListener(this);
	...
	public void onClick(View v) {
		// TODO Auto-generated method stub
		switch (v.getId()) {
		case R.id.url_qrmake_btn:
			Intent intent = new Intent(URLActivity.this, QRSettingActivity.class);
	...
	private SignImageView makeViewDraw(int id, int mode, int width, int height, 
		...
		SignImageView child = new SignImageView(URLActivity.this);
		child.setId(id);
